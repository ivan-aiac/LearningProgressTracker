...
public class StudentService {
    ...
    public List<Notification> getStudentsFinishedCoursesNotifications() {
        return database.listStudentsCoursesNotifications();
    }

    public int getLastNumberOfNotifiedStudents() {
        return database.getLastNumberOfNotifiedStudents();
    }
}
