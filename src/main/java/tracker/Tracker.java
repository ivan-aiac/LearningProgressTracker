...
public class Tracker {
    ...
    private void notifyCommand() {
        List<Notification> notifications = studentService.getStudentsFinishedCoursesNotifications();
        notifications.forEach(System.out::print);
        System.out.printf("Total %d students have been notified.%n", studentService.getLastNumberOfNotifiedStudents());
        back();
    }
